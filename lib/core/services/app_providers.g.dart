...
String _$accountCommandsHash() => r'6abdb212d58d4e900ec6c8ab7b57415f304d7a94';

/// See also [AccountCommands].
@ProviderFor(AccountCommands)
final accountCommandsProvider =
    AutoDisposeAsyncNotifierProvider<AccountCommands, void>.internal(
  AccountCommands.new,
...
typedef _$AccountCommands = AutoDisposeAsyncNotifier<void>;
String _$cardCommandsHash() => r'90cec7dbdad0c185f472bf3ff5db7e824b4bb809';

/// See also [CardCommands].
@ProviderFor(CardCommands)
final cardCommandsProvider =
    AutoDisposeAsyncNotifierProvider<CardCommands, void>.internal(
  CardCommands.new,
...
typedef _$CardCommands = AutoDisposeAsyncNotifier<void>;
String _$expenseCommandsHash() => r'f2b55957a520263225d3e3958bd39e2c9e082a84';

/// See also [ExpenseCommands].
@ProviderFor(ExpenseCommands)
final expenseCommandsProvider =
    AutoDisposeAsyncNotifierProvider<ExpenseCommands, void>.internal(
  ExpenseCommands.new,
...
typedef _$ExpenseCommands = AutoDisposeAsyncNotifier<void>;
